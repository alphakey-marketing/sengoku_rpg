...
export default function EquipmentPage() {
  ...
  // equipmentGrants is already filtered to active (non-superseded) grants by the hook
          ...
          {sortedEquipment.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {sortedEquipment.map((item) => {
                ...
                // equipmentGrants is pre-filtered to active grants only — no isSuperseded guard needed
                const itemGrant = equipmentGrants.find((g) => g.gameRowId === item.id);
                return (
                  <div
                    key={item.id}
                  ...
                  >
                    ...
                    {/* Story grant passive badge — only shown when a grant is linked to this item */}
                    {itemGrant && (
                      <Tooltip>
