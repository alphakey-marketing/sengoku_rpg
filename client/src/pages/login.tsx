 ...
 *
 * Phase 5: Replit redirect branch removed.
 * Always renders the Supabase "Sign in with Google" OAuth button.
 *
 * <AuthGuard> redirects unauthenticated users here from any protected route.
 * The landing page "ENTER THE REALM" button also navigates here via wouter.
 */
